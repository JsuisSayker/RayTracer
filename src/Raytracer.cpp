...
int RayTracer::Raytracer::run(std::string scene_file)
{
  ...
  //     Math::Point3D(0, -1000, 0), 1000, ground_material));
  ...
  //         world.addPrimitive(std::make_shared<RayTracer::Sphere>(center, center2, 0.2, sphere_material));
  ...
  // std::shared_ptr<Material::Dielectric> material1 =
  //     std::make_shared<Material::Dielectric>(1.5);
  // world.addPrimitive(std::make_shared<RayTracer::Sphere>(
  //     Math::Point3D(0, 1, 0), 1.0, material1));

  // std::shared_ptr<Material::Lambertian> material2 =
  //     std::make_shared<Material::Lambertian>(Math::Vector3D(0.4, 0.2, 0.1));
  // world.addPrimitive(std::make_shared<RayTracer::Sphere>(
  //     Math::Point3D(-4, 1, 0), 1.0, material2));
